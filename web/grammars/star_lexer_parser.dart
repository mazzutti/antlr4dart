...
class StarLexerParser extends Parser {
  ...
  StarLexerParser(TokenSource input) : super(input) {
...
class AContext extends ParserRuleContext {
  ...
  int get ruleIndex => StarLexerParser.RULE_A;

  TerminalNode getA() => getToken(StarLexerParser.A, 0);
}
