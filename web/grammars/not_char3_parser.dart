...
class NotChar3Parser extends Parser {
  ...
  NotChar3Parser(TokenSource input) : super(input) {
...
class AContext extends ParserRuleContext {
  ...
  int get ruleIndex => NotChar3Parser.RULE_A;

  TerminalNode getA() => getToken(NotChar3Parser.A, 0);
}
