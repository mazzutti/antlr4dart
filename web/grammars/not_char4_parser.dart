...
class NotChar4Parser extends Parser {
  ...
  NotChar4Parser(TokenSource input) : super(input) {
...
class AContext extends ParserRuleContext {
  ...
  int get ruleIndex => NotChar4Parser.RULE_A;

  TerminalNode getA() => getToken(NotChar4Parser.A, 0);
}
