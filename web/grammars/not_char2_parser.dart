...
class NotChar2Parser extends Parser {
  ...
  NotChar2Parser(TokenSource input) : super(input) {
...
class AContext extends ParserRuleContext {
  ...
  int get ruleIndex => NotChar2Parser.RULE_A;

  TerminalNode getA() => getToken(NotChar2Parser.A, 0);
}
