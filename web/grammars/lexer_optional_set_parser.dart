...
class LexerOptionalSetParser extends Parser {
  ...
  LexerOptionalSetParser(TokenSource input) : super(input) {
...
class AContext extends ParserRuleContext {
  ...
  int get ruleIndex => LexerOptionalSetParser.RULE_A;

  TerminalNode getA() => getToken(LexerOptionalSetParser.A, 0);
}
