// Generated from Headers.g by antlr4dart
part of headers;

class HeadersParser extends Parser {
  ...
  HeadersParser(TokenSource input) : super(input) {
  ...
  String get grammarFileName => "Headers.g";
  SContext s() {
...
class SContext extends ParserRuleContext {
  ...
  int get ruleIndex => HeadersParser.RULE_S;
...
class AContext extends ParserRuleContext {
  ...
  int get ruleIndex => HeadersParser.RULE_A;

  TerminalNode getB() => getToken(HeadersParser.B, 0);
}
