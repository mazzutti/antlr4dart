...
class LexerPlusSetParser extends Parser {
  ...
  LexerPlusSetParser(TokenSource input) : super(input) {
...
class AContext extends ParserRuleContext {
  ...
  int get ruleIndex => LexerPlusSetParser.RULE_A;

  TerminalNode getA() => getToken(LexerPlusSetParser.A, 0);
}
