// Generated from NoTruePreds.g by antlr4dart
part of no_true_preds;

class NoTruePredsParser extends Parser {
  ...
  NoTruePredsParser(TokenSource input) : super(input) {
  ...
  String get grammarFileName => "NoTruePreds.g";
  SContext s() {
...
class SContext extends ParserRuleContext {
  ...
  int get ruleIndex => NoTruePredsParser.RULE_S;
...
class AContext extends ParserRuleContext {
  ...
  int get ruleIndex => NoTruePredsParser.RULE_A;

  TerminalNode getINT() => getToken(NoTruePredsParser.INT, 0);

  TerminalNode getID() => getToken(NoTruePredsParser.ID, 0);
}
