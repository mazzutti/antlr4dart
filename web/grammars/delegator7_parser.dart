...
class Delegator7Parser extends Parser {
  ...
  Delegator7Parser(TokenSource input) : super(input) {
...
class SContext extends ParserRuleContext {
  ...
  int get ruleIndex => Delegator7Parser.RULE_S;
...
class XContext extends ParserRuleContext {
  ...
  int get ruleIndex => Delegator7Parser.RULE_X;

  TerminalNode getA() => getToken(Delegator7Parser.A, 0);
}
...
class YContext extends ParserRuleContext {
  ...
  int get ruleIndex => Delegator7Parser.RULE_Y;
