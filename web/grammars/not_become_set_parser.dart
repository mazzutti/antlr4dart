...
class NotBecomeSetParser extends Parser {
  ...
  NotBecomeSetParser(TokenSource input) : super(input) {
...
class AContext extends ParserRuleContext {
  ...
  int get ruleIndex => NotBecomeSetParser.RULE_A;

  TerminalNode getC() => getToken(NotBecomeSetParser.C, 0);
}
