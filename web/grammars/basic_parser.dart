...
class BasicParser extends Parser {
  ...
  BasicParser(TokenSource input) : super(input) {
  ...
  String get grammarFileName => "Basic.g";
  SContext s() {
...
class SContext extends ParserRuleContext {
  ...
  int get ruleIndex => BasicParser.RULE_S;

  AContext getA() => getRuleContext((c) => c is AContext, 0);

  void enterRule(ParseTreeListener listener) {
    if (listener is BasicListener) 
...
class AContext extends ParserRuleContext {
  ...
  int get ruleIndex => BasicParser.RULE_A;

  List<TerminalNode> getINTs() => getTokens(BasicParser.INT);

  TerminalNode getID() => getToken(BasicParser.ID, 0);

  TerminalNode getINT(int i) => getToken(BasicParser.INT, i);
